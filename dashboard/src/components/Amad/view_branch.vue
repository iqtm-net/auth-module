    ...
    <div ref="bdy">
        ...
        <div class="main-content-wrapper d-flex clearfix">  
            ...
            <div class="mobile-nav">
                ...
                <!-- Navbar Toggler -->
                <div class="amado-navbar-toggler" @click.prevent="header_toggle">
                    <span></span><span></span><span></span>
                </div>

                <!-- Navbar Brand -->
                <div class="amado-navbar-brand">
                    <a href="index.html"><img :src="OrderData.theme_logo" alt=""></a>
                </div>
            ...
            <header v-if="mob_header" class="header-area clearfix">
                ...
                <!-- Close Icon -->
                <div class="nav-close" @click.prevent="header_close">
                    <i class="fa fa-close" aria-hidden="true"></i>
                </div>
                ...
                <nav class="amado-nav uk-flex uk-flex-center">
                    <ul>
                        <li class="active">
                            <a href="index.html" class="uk-text-cairo">الرئيسية</a>
                        </li>
                        <li v-for="branch in Store_Branches" v-bind:key="branch.id">
                            <a :href="`/${branch.id}`" class="uk-text-cairo" >{{branch.branch}}</a>
                            <!-- <router-link class="uk-text-cairo" :to="{ name: 'view_branch', params: { branch: branch.id }}">{{branch.branch}}</router-link> -->
                            <!-- <router-link class="uk-text-cairo" :to="{ name: 'view_branch', params: { branch: branch.id }}">{{branch.branch}}</router-link> -->
                        </li>
                    </ul>
                </nav>
            ...
            <div class="products-catagories-area" ref="scroll_d">
                            ...
                            <div class="box-up">
                                ...
                                <div class="img-info">
                                    ...
                                    <div class="a-size uk-text-cario">
                                        ...
                                        <div class="uk-margin-bottom">{{data[1].description}}</div>

                                        <div class="uk-margin-bottom"><span class="size"> <span v-for="(size,index) in data[1].sizes" v-bind:key="index">{{size}}</span> </span> الاحجام </div>
                                        
                                        <div class="uk-flex uk-flex-center">
                                            <div v-for="(color,index) in data[1].colors" v-bind:key="index" v-bind:style="`background-color:${color};`" class="colors"></div>
                                            <div class=""> الالوان </div> 
                                        </div>
                            ...
                            <div class="box-down">
                                ...
                                <a class="cart" href="#">
                                    ...
                                    <span class="add-to-cart">
                                        <span class="txt uk-text-bold uk-text-medium uk-text-cario">شراء</span>
                                    </span>
                                </a>
                            </div>
                ...
                <div v-if="Store_Items.length <= 0 && items_res" align="center">
                    <h1 class="uk-text-muted"> لا يوجد عناصر</h1>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single_widget_area">
                            ...
                            <!-- Copywrite Text --> 
                            <p class="copywrite">
                                This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i>by <a href="https://hodhodplatform.com" target="_blank">HodHod Platform</a>
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="footerNavContent">
                                        <ul class="navbar-nav ml-auto">
                                            <li v-for="branch in data.store_footer_branches" v-bind:key="branch.id" class="nav-item">
                                                <a class="nav-link" href="shop.html">{{branch.branch}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
    ...
    export default {
        ...
        methods: {
            ...
            main(){
                ...
                axios.get(`/api/check_shared_link_code/${store_name[0]}`)
                .then(res => {      
                ...
                if(this.$route.params.Order_id !== undefined){
                    axios.get(`/api/view_item/${this.$route.params.Order_id}`)
                    .then(res => {      
                        this.item_data = res.data.data;
                        UIkit.modal('#View').show();
                    })
                    .catch(res => {
            ...
            get_branche_items_pag(){
                ...
                axios.get(`/api/get_branche_items_pag/${store_name[0]}/${this.$route.params.branch}?page=${this.items_pag}`)
                .then(res => {   
                    
                    var v = this;
                    let storeitems = new Map(res.data.data);
                    storeitems.forEach(function(value, key, map){
