    ...
    <div class="uk-margin">
        ...
        <div id="ViewAccount" uk-modal>
            <div class="uk-modal-dialog uk-modal-body">
                <view-account :Account="ViewAccountData" :Account_Role="'stores'" :Account_Role_Number="3"></view-account>
            </div>
        </div>
        ...
        <div id="NotifyAccount" uk-modal>
            <div class="uk-modal-dialog uk-modal-body">
                <notify-account :Account="ViewAccountData" :Account_Role="'stores'"></notify-account>
            </div>
        </div>
        ...
        <div id="ViewOrders" uk-modal class="uk-child-width-expand">
            <div class="uk-modal-dialog uk-modal-body">
                <view-orders :Account_Id="ViewAccountData.id" :Account_Role_Number="3"></view-orders>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchArticles(Page){
                this.axios.get(process.env.VUE_APP_URL+`/api/Admin/modify_account_get/stores?page=${Page}`)
                .then(res => {
                    this.isLoaded = true;
            ...
            Searching(){
                if(this.search_data == ''){ this.fetchArticles(1); }
                    ...
                    this.axios.get(process.env.VUE_APP_URL+`/api/Admin/search_for_account/${this.search_data}/stores`)
                    .then(res => {
                        if (res.status == 200) {
